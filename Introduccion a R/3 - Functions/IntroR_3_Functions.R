...
X.sim    <- matrix(rnorm(100),ncol=2)    # Regresores
eps      <- matrix(rnorm(50),ncol=1)     # Ruido
...
f <- function() {x<-2; print(x)}  # Una funcion que hace que x sea igual a 2
