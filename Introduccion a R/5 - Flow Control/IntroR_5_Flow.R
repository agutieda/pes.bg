...
X <- rep(NaN,10,1) # Iniciamos creando un vector sin numeros
...
sum(moneda)  # Numero de caras
mean(moneda) # Probabilidad de sacar cara
...
sum(rbinom(1,size=1000,prob=0.5))
...
# promedio que puede jugar Falcao antes de lesionarse a parrtir de simulaciones
...
x11(); plot(pVector,partidosVector)
